							...
							<div class="row">
								...
								<div class="col-sm-6 text-right">
									<a class="btn btn-primary btn-sm"
										href="${pageContext.request.contextPath }/java/user"><i
				...
				<div class="col-sm-7">
					<div class="element-wrapper">
						<div class="element-box">
							...
							<form
								action="${pageContext.request.contextPath }/java/user/save"
								...
								<div class="form-group">
									<label>Department</label> <input class="form-control"
										id="department" name="department" value="${user.department.departmentName }"
										readonly="readonly" />
								</div>
