		...
		<div class="top-menu-controls">
			<div
				...
				<div class="os-dropdown">
					...
					<ul>
						<li><a
							href="${pageContext.request.contextPath }/java/admin/subject"><i
								class="os-icon os-icon-book"></i><span>Subject</span></a></li>
						<li><a
							href="${pageContext.request.contextPath }/java/admin/questionType"><i
			...
			<div class="logged-user-w">
				<div class="logged-user-i">
					...
					<div class="logged-user-menu color-style-bright"
						...
						<ul>
							<li><a href="${pageContext.request.contextPath }/java/admin/profile"><i
