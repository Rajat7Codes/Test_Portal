					...
					<div class="col-lg-4">
						<div class="element-wrapper">
							<div class="element-box">
								<form:form
									action="${pageContext.request.contextPath }/web/admin/subject/save"
												...
												<tr>
													...
													<td class="valigntop"><div class="btn-group">
															...
															<ul class="dropdown-menu pull-left" role="menu">
																<li><a title="Delete"
																	href="<c:url value='/web/admin/subject/delete/${subject.subjectId }' />"><i
																		class="fa fa-trash"></i>Delete</a></li>
																<li><a title="Edit"
																	href="<c:url value='/web/admin/subject/edit/${subject.subjectId }' />"><i
