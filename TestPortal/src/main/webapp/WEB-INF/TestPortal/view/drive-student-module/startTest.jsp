...
function xm() {
  ...
  $.ajax({
    type: "GET",
    url: "${pageContext.request.contextPath}/drive/student/start/test/compiler",
...
<script type="text/javascript">
	...
	$.ajax({
	type: "GET",
	url: "${pageContext.request.contextPath}/drive/student/end/test",
	   	contentType : "application/json",
	data : dataJ,
	dataType : 'json',
	cache : false,
	...
	success: function(e) {
		window.alert("Test Submission Successfully");
	 	window.location="${pageContext.request.contextPath}/drive/student/view/test/result/"+e["testId"]
	},
	error: function(e) { 
